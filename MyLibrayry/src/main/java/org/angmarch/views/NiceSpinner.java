...
public class NiceSpinner extends TextView {
    ...
    private int backgroundPanelDriop;
    private  int coloArrow;
    ...
    private void init(Context context, AttributeSet attrs) {
	   ...
	   setGravity(Gravity.CENTER);
        ...
        backgroundSelector = typedArray.getColor(R.styleable.NiceSpinner_backgroundSelector, -1);
    //  setBackgroundResource(backgroundSelector);
        textColor = typedArray.getColor(R.styleable.NiceSpinner_textTint, -1);
      //  setTextColor(textColor);
        backgroundPanelDriop = typedArray.getColor(R.styleable.NiceSpinner_backgorud_content_drop, -1);
      //  setTextColor(textColor);
        ...
        listView.setCacheColorHint(backgroundPanelDriop);
 ...
 //       popupWindow.setBackgroundDrawable();
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            ...
            popupWindow.setBackgroundDrawable(Utit.getDrawable(context, R.drawable.spinner_drawable));
        } else {
            popupWindow.setBackgroundDrawable(Utit.getDrawable(context, R.drawable.drop_down_shadow));
        }
        setBackgroundColor(backgroundPanelDriop);
        ...
        if (!isArrowHide) {
            ...
            int resId = typedArray.getColor(R.styleable.NiceSpinner_arrowTintColor, -1);
    ...
    public void setBackgroundColor(int color) {
        ...
        if (background instanceof StateListDrawable) { // pre-L
            try {
                ...
                int[] colors = {Utit.darker(color, 0.85f), color};
